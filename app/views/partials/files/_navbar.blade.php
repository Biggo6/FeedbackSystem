            ...
            <div class="navbar-custom">
                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu">
                        ...
                        <li class="has-submenu {{HelperX::activeRoute('question.create')}}">
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="components-carousel.html"><i class="fa fa-list"></i> Manage Questions</a></li>
                        ...
                        <li class="has-submenu {{HelperX::activeRoute('configure.subDepartments')}}{{HelperX::activeRoute('configure.departments')}}{{HelperX::activeRoute('configure.system')}}{{HelperX::activeRoute('configure.possibleSolns')}}">
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="components-carousel.html"><i class="fa fa-key"></i> Roles</a></li>
                                <li><a href="components-carousel.html"><i class="fa fa-list"></i> Permissions</a></li>
